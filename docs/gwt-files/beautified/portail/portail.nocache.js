function portail() {
  var N = 'bootstrap',
    ...
    Vb = 'portail.devmode.js',
    Wb = '85D2B992F6111BC9BF615C4D657B05CC',
    Xb = ':1',
    Yb = ':2',
    Zb = ':3',
    $b = ':4',
  ...
  portail.__sendStats = q;
  portail.__moduleName = R;
  portail.__errFn = null;
  portail.__moduleBase = T;
  portail.__softPermutationId = U;
  portail.__computePropValue = null;
  portail.__getPropMap = null;
  portail.__installRunAsyncCode = function() {};
  portail.__gwtStartLoadingFragment = function() {
    return null
  };
  portail.__gwt_isKnownPropertyValue = function() {
    return false
  };
  portail.__gwt_getMetaProperty = function() {
    return null
  };
  var r = null;
  ...
  portail.__moduleStartupDone = function(e) {
    var f = s[R].bindings;
    s[R].bindings = function() {
      var a = f ? f() : {};
      var b = e[portail.__softPermutationId];
  ...
  function w(f) {
    ...
    function h(a) {
      ...
      if (portail.__errFn) {
        d.onerror = function() {
          portail.__errFn(R, new Error(gb + a))
        }
      }
      c.appendChild(d);
      q(hb, ib)
  ...
  portail.__startLoadingFragment = function(a) {
    return C(a)
  };
  portail.__installRunAsyncCode = function(a) {
    var b = u();
    var c = b.body;
    var d = b.createElement(eb);
    d.language = fb;
  ...
  function D() {
    ...
    portail.__computePropValue = k;
    n.__gwt_activeModules[R].bindings = portail.__getPropMap;
    q(N, Ub);
    if (p()) {
      return C(Vb)
    }
  ...
  A();
  portail.__moduleBase = B();
  s[R].moduleBase = portail.__moduleBase;
  var G = D();
  if (n) {
